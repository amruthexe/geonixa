...
export default function AppInvestmentPaymentStructure(): JSX.Element {
    ...
    <section className="w-full px-4 py-10 md:py-16 bg-white text-slate-900">
      <div className="mx-auto max-w-6xl">
            ...
            >
              ...
              <div className="space-y-4 text-lg">
                <div className="flex justify-between items-center pb-2 border-b border-orange-100">
                  ...
                  <span className="font-semibold text-slate-900">₹60,000</span>
                </div>
          ...
          >
            ...
            <div className="space-y-5">
              <motion.div variants={itemVariants} className="flex items-start gap-4">
                <Smartphone size={26} className="text-orange-600 mt-1 flex-shrink-0" />
                <div>
                  <h4 className="text-lg font-semibold text-slate-900">
              ...
              <motion.div variants={itemVariants} className="flex items-start gap-4">
                <CloudUpload size={26} className="text-orange-600 mt-1 flex-shrink-0" />
                <div>
                  <h4 className="text-lg font-semibold text-slate-900">
              ...
              <motion.div variants={itemVariants} className="flex items-start gap-4">
                <Cpu size={26} className="text-orange-600 mt-1 flex-shrink-0" />
                <div>
                  <h4 className="text-lg font-semibold text-slate-900">
        ...
        >
          ...
          100% Job Guarantee after App Development Course Completion
        </motion.div>
      </div>
    </section>
  );
