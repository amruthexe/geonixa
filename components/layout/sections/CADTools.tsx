...
const tools = [
  ...
  { src: 'https://cdn.simpleicons.org/solidworks', alt: 'SolidWorks CAM' },
  { src: 'https://cdn.simpleicons.org/creo', alt: 'PTC Creo' },
  { src: 'https://cdn.simpleicons.org/step', alt: 'STEP' },
  { src: 'https://cdn.simpleicons.org/iges', alt: 'IGES' },
];
    ...
    <section className="bg-white py-12 px-4">
      <div className="max-w-6xl mx-auto text-center">
        <h2 className="text-2xl md:text-3xl font-bold mb-10">
          Tools & Technologies You'll Learn in AutoCAD & SolidWorks
        </h2>
