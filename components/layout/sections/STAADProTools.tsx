...
const tools = [
  ...
  { src: 'https://cdn.simpleicons.org/staadpro', alt: 'STAAD Pro' },
  ...
  { src: 'https://cdn.simpleicons.org/msproject', alt: 'Microsoft Project' },
...
export default function STAADProTools() {
  return (
    <section className="bg-white py-12 px-4">
      <div className="max-w-6xl mx-auto text-center">
        <h2 className="text-2xl md:text-3xl font-bold mb-10">
          Tools & Technologies You'll Learn in STAAD Pro
        </h2>
