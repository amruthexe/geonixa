            ...
            >
              ...
              <div className="space-y-4 text-lg">
                ...
                <div className="flex justify-between items-center pt-2">
                  ...
                  <span className="font-bold text-amber-700 text-xl">₹45,000</span>
                </div>
              </div>
            </motion.div>
            ...
            >
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                ...
                >
                  ...
                  <p className="text-sm text-slate-600">Pay ₹50,000 upfront</p>
                </button>
                ...
                >
                  ...
                  <p className="text-sm text-slate-600">₹15,000 × 3 Months</p>
                </button>
              </div>
            </motion.div>
          </div>
