...
export default function MonthOneTwo() {
  return (
    <section
    ...
    >
      ...
      >
        <h1 className="text-4xl sm:text-5xl font-black text-gray-900 mb-3 tracking-tight">
          Month 1–2:{" "}
          <span className="text-orange-700">Foundation & Frontend Mastery</span>
        </h1>
          ...
          <div className="mb-6">
            ...
            <ul className="space-y-2 text-gray-700 text-sm">
              ...
              <li className="flex items-center gap-2">
                ...
                <span>VS Code, Chrome DevTools</span>
              </li>
            </ul>
          </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              <div className="bg-orange-50 border border-orange-100 rounded-xl p-3 flex flex-col shadow-sm">
                <div className="flex items-center gap-2 mb-1">
                  <Layout className="w-4 h-4 text-orange-700" />
              ...
              <div className="bg-orange-50 border border-orange-100 rounded-xl p-3 flex flex-col shadow-sm">
                ...
                <p className="text-xs text-gray-600">
                  Product landing page for startup
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="mb-6">
            ...
            <ul className="space-y-2 text-gray-700 text-sm">
              <li className="flex items-center gap-2">
                ...
                <span>React.js (Hooks, Components, State)</span>
              </li>
              <li className="flex items-center gap-2">
              ...
              <li className="flex items-center gap-2">
                ...
                <span>API Integration (Fetch, Axios)</span>
              </li>
              <li className="flex items-center gap-2">
                <Rocket className="w-4 h-4 text-green-600" />
                <span>Routing & Deployment</span>
              </li>
            </ul>
          </div>
      ...
      <div className="text-center mt-12 max-w-3xl mx-auto">
        <p className="text-gray-700 font-medium">
          <span className="text-orange-700 font-semibold">Outcome:</span> Strong
          foundation in web development and React.js
        </p>
        <p className="text-sm text-gray-500 mt-1">
          By the end of Month 2, students can build dynamic UI applications.
        </p>
      </div>
    </section>
  );
