...
export default function FullStackWebPromo() {
    ...
    <main className="min-h-screen bg-gray-50 relative overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-20 pb-16 flex flex-col lg:flex-row gap-12 items-center">
        ...
        <div className="flex flex-col items-center text-center lg:items-start lg:text-left lg:w-1/2 space-y-8">
          <h1 className="text-4xl md:text-6xl font-bold text-gray-900">Full Stack Web Development</h1>
          <h2 className="text-2xl md:text-3xl font-semibold text-gray-700">
            Build Websites & Web Apps from Scratch!
          </h2>

          <div className="flex flex-col gap-4">
            <p className="text-lg text-gray-700">
              Learn HTML, CSS, JavaScript, Node.js, and React in one complete program.
            </p>
            <p className="text-lg text-gray-700">
              Perfect for beginners & professionals with hands-on projects and deployment skills.
            </p>
            ...
            <p className="text-md text-gray-700">
              Live Projects + Certification + Career Guidance Included.
            </p>
          </div>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center sm:items-start">
            ...
            >
              <Link href="https://wa.me/919606995925?text=Hi%2C%20I'm%20interested%20in%20your%20Full%20Stack%20Web%20Development%20course.">
                Start at ₹4999
          ...
          {showForm && (
            <div className="mt-10 w-full bg-white border border-gray-200 rounded-3xl shadow-xl p-8 transition-all duration-300">
              <h3 className="text-2xl font-bold text-center text-gray-900 mb-6 tracking-tight">
                🚀 Start Building Web Apps Today!
              </h3>
              <p className="text-center text-gray-500 mb-6 text-sm sm:text-base">
                Fill in your details & we’ll send you the complete course info.
              </p>
              ...
              {submitted ? (
                ...
                <form onSubmit={handleSubmit} className="space-y-5">
                  ...
                  <input
                    type="text"
                    placeholder="Interested Stack (e.g., MERN, MEAN)"
                    className="w-full bg-white text-gray-800 placeholder-gray-400 border border-gray-300 p-3 rounded-xl focus:outline-none focus:ring-2 focus:ring-black transition-all"
                    required
                    value={form.domain}
