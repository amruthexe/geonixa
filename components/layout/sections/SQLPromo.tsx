...
export default function SQLPromo() {
    ...
    <main className="min-h-screen bg-gray-50 relative overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-20 pb-16 flex flex-col lg:flex-row gap-12 items-center">
        <div className="flex flex-col items-center text-center lg:items-start lg:text-left lg:w-1/2 space-y-8">
          <h1 className="text-4xl md:text-6xl font-bold text-gray-900">SQL Programming Course</h1>
          <h2 className="text-2xl md:text-3xl font-semibold text-gray-700">
            Master SQL for Data Analysis and Management!
          </h2>

          <div className="flex flex-col gap-4">
            <p className="text-lg text-gray-700">
              Learn SQL from scratch and build data-driven applications with hands-on projects.
            </p>
            <p className="text-lg text-gray-700">
              Ideal for beginners and professionals looking to excel in database management and analysis.
            </p>
            <div className="flex justify-center lg:justify-start items-center gap-2 text-xl">
              <span className="text-yellow-500">⭐⭐⭐⭐⭐</span>
              <span className="text-gray-600">4.8/5 Rated by 10,000+ learners</span>
            </div>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center sm:items-start">
            ...
            >
              <Link href="https://wa.me/919606995925?text=Hi%2C%20I'm%20interested%20in%20your%20SQL%20Programming%20course.">
        ...
        <div className="relative w-full lg:w-1/2">
          ...
          >
            <img
              src="/html.jpeg"
              alt="SQL Programming Course Demo"
            ...
            <div className="mt-10 w-full bg-white border border-gray-200 rounded-3xl shadow-xl p-8 transition-all duration-300">
              ...
              {submitted ? (
                ...
                <form onSubmit={handleSubmit} className="space-y-5">
                  ...
                  <input
                    type="text"
                    placeholder="Interested Domain (e.g., Data Analysis, Full Stack Dev)"
                    className="w-full bg-white text-gray-800 placeholder-gray-400 border border-gray-300 p-3 rounded-xl focus:outline-none focus:ring-2 focus:ring-black transition-all"
                    required
                    value={form.domain}
