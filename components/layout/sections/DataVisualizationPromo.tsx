...
export default function DataVisualizationPromo() {
    ...
    <main className="min-h-screen bg-gray-50 relative overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-20 pb-16 flex flex-col lg:flex-row gap-12 items-center">
        <div className="flex flex-col items-center text-center lg:items-start lg:text-left lg:w-1/2 space-y-8">
          <h1 className="text-4xl md:text-6xl font-bold text-gray-900">Data Visualization with Power BI & Tableau</h1>
          <h2 className="text-2xl md:text-3xl font-semibold text-gray-700">
            Unlock the Power of Data Insights with Visual Storytelling!
          </h2>

          <div className="flex flex-col gap-4">
            <p className="text-lg text-gray-700">
              Learn how to transform raw data into actionable insights using the best data visualization tools.
            </p>
            <p className="text-lg text-gray-700">
              Perfect for analysts and professionals looking to showcase data in a more impactful way.
            </p>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center sm:items-start">
            ...
            >
              <Link href="https://wa.me/919663216581?text=Hi%2C%20I'm%20interested%20in%20your%20Data%20Visualization%20course.">
            ...
            <div className="mt-10 w-full bg-white border border-gray-200 rounded-3xl shadow-xl p-8 transition-all duration-300">
              ...
              {submitted ? (
                ...
                <form onSubmit={handleSubmit} className="space-y-5">
                  ...
                  <input
                    type="text"
                    placeholder="Interested Domain (e.g., Data Visualization)"
                    className="w-full bg-white text-gray-800 placeholder-gray-400 border border-gray-300 p-3 rounded-xl focus:outline-none focus:ring-2 focus:ring-black transition-all"
                    required
                    value={form.domain}
