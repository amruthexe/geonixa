...
export default function UIUXPromo() {
    ...
    <main className="min-h-screen bg-gray-50 relative overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-20 pb-16 flex flex-col lg:flex-row gap-12 items-center">
        ...
        <div className="flex flex-col items-center text-center lg:items-start lg:text-left lg:w-1/2 space-y-8">
          <h1 className="text-4xl md:text-6xl font-bold text-gray-900">UI/UX Design Course</h1>
          <h2 className="text-2xl md:text-3xl font-semibold text-gray-700">
            Design with Empathy. Prototype with Precision.
          </h2>

          <div className="flex flex-col gap-4">
            <p className="text-lg text-gray-700">
              Learn UI/UX from scratch — from user research, wireframes, and design systems to Figma & prototyping.
            </p>
            <p className="text-lg text-gray-700">
              Ideal for aspiring designers, developers, and product thinkers.
            </p>
            ...
            <p className="text-md text-gray-700">
              Project-based + Certification + Career Support included.
            </p>
          </div>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center sm:items-start">
            ...
            >
              <Link href="https://wa.me/919999999999?text=Hi%2C%20I'm%20interested%20in%20your%20UI/UX%20Design%20course.">
