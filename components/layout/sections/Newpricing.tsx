        ...
        <div className="flex flex-col items-center justify-center    w-full relative">
            <Container>
                <div className="flex flex-col items-center text-center max-w-xl mx-auto">
                    ...
                    <h2 className="text-3xl md:text-4xl lg:text-4xl font-heading font-bold !leading-snug ">
                         Pricing section
                    </h2>
...
const Plan = ({
    ...
    return (
        <div key={index} className="w-full relative flex flex-col saturate-150 rounded-2xl">
            ...
            >
                {id === "pro" && (
                    <div className="max-w-fit min-w-min inline-flex items-center whitespace-nowrap px-1 h-7 rounded-full dark:bg-blue-500 bg-red-600 absolute -top-3 left-1/2 -translate-x-1/2 select-none">
                        <span className="flex-1 text-sm px-2 font-medium text-white">
                            Most Popular
                        </span>
                    </div>
                )}
                        ...
                        <AnimatePresence>
                            {(id !== "free" && plan === "yearly") && (
                                <motion.span
                                    ...
                                    aria-hidden="true"
                                    className="text-xs px-2 py-0.5 rounded mb-1 bg-red-600 text-white font-medium"
                                >
                                    -20%
                                </motion.span>
                            )}
                    ...
                    <ul className="flex flex-col gap-2">
                        {features.map((feature, index) => (
                            <li key={index} className="flex items-center gap-2">
                                <CheckIcon aria-hidden="true" className="w-5 h-5 text-black" />
