...
import { ConstructionPlanningPricingSection } from '@/components/layout/sections/ConstructionPlanningPricingSection'
import ConstructionPlanningPromo from '@/components/layout/sections/ConstructionPlanningPromo'
import ConstructionPlanningSyllabus from '@/components/layout/sections/ConstructionPlanningSyllabus'
import ConstructionPlanningTools from '@/components/layout/sections/ConstructionPlanningTools'
...
const page = () => {
  return (
    <div>
       <ConstructionPlanningPromo/>
       <ConstructionPlanningSyllabus/>
       <ConstructionPlanningTools/>
       {/* <ConstructionPlanningPricingSection/> */}
       <Reviews/>
    <Collaborations/>
    <GetCertified/>
    <FAQSection/>
